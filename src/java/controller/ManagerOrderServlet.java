...
public class ManagerOrderServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.setAttribute("allOrder", order.getAllOrder());
    ...
    throws ServletException, IOException {
        ...
        try {
            if(id_raw != null) {
                ...
                order.updateOrderToPending(id_raw);
                order.updateQuantityInStockToPending(id_raw);
        ...
        response.sendRedirect("pendinglist");
        //request.getRequestDispatcher("Views/ManagerOrder.jsp").forward(request, response);
    }
