...
public class DetailOrder extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<OrderDetail> listOD = order.getAllOrderDetailByOrderID(id_raw);
        
        request.setAttribute("orderDetailByOrderID", listOD);
        request.getRequestDispatcher("Views/DetailOrder.jsp").forward(request, response);
    } 
